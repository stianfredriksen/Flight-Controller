...
void loop() {
  ...
  if (start == 2) {                                                         //The motors are started.
    ...
    servo_1 = map(esc_1, 1000, 2000, 80, 110 );
    servo_2 = map(esc_2, 1000, 2000, 80, 110);
    servo_3 = map(esc_3, 1000, 2000, 110, 80);
    servo_4 = map(esc_4, 1000, 2000, 110, 80); //what is the middle value 1500 throttle? (0 deg -> +7 deg, find the values)
